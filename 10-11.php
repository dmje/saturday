        ...
        ?>
            <div class="masonry-item masonry-item-text">
                <div class="song-explanation">
                    ...
                    <p>More piano to start. Might as well while the mics are setup...</p>
                    <p>I'm too fond of delay and verb, it's a combination that I love, but I overuse it</p>
                    <P>The amazing Spitfire strings in this one. They're lovely. And then the drums, loop - a bit of clip shift to keep the ears occupied, a slight DJ Shadow to the loop...</p>
                </div>
            </div>
        <?php
            endif;
